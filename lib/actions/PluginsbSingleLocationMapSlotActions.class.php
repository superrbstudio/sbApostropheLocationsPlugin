...
/**
 * Description of PluginsbSingleLocationMapSlotActions
 *
 * @author giles
 */
class PluginsbSingleLocationMapSlotActions extends aSlotActions 
{
  public function executeEdit(sfRequest $request)
  {
    ...
    $this->form = new sbSingleLocationMapSlotEditForm($this->id, array());
